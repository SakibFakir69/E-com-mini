...
function Card({ title, image, price, _id,product,handelCart }) {
  ...
  return (
    <div className="h-[200px]   flex justify-center items-center  flex-col border border-stone-200 p-1  shadow-[0px_0px_0px_0px] hover:shadow hover:border-white rounded ">
      ...
      <div className="w-full flex justify-between">
        ...
        <div className="py-6">
          <button onClick={()=>handelCart(product)} className=" bg-[#6366F1] px-4 py-1 rounded text-white cursor-pointer">
            Add to Cart
          </button>
        </div>
      </div>
